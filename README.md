...
> Please see our [iOS 13 Migration Guide](https://github.com/twilio/twilio-voice-ios/blob/Releases/iOS-13-Migration-Guide.md) for the latest information on iOS 13 and iPadOS 13.
...
* [Migration Guide from 2.x to 3.x](https://github.com/twilio/voice-quickstart-objc/blob/master/Docs/migration-guide-2.x-3.x.md) - Migrating from 2.X to 3.x
