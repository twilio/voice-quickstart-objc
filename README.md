...
## Quickstart
To get started with the Quickstart application follow these steps. Steps 1-6 will enable you to make a call. The remaining steps 7-10 will enable the application to receive incoming calls in the form of push notifications using Apple’s VoIP Service.
...
8. [Create a Push Credential with your VoIP certificate](#bullet8)
...
Put the remaining `APP_SID` configuration info into `server.py` 
...
* [AppleDoc](https://media.twiliocdn.com/sdk/ios/voice/releases/2.0.0-beta6/docs/)
